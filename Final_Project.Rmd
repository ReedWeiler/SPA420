...
We cite the software we use. For example, we conduct our analysis using R version `r paste(R.version$major, R.version$minor, sep = ".")` [@rcoreteam21]. We rely on several elements of the `tidyverse` [@wickhamtidyverse].
